...
::Set PROJ_PFAD= C:\Users\YUWEPAN\Desktop\Lieferanterkennung\
SET PROJ_PFAD=I:\A-D\CAD-KI\Lieferanterkennung\
...
%PYTHON_BIN%python.exe -d DetectObjekt.py %PROJ_PFAD%MessPunktMarker\Classifier\cascade.xml
 ::cascade_Mercedes_Logo__Stern__V07.xml
::%PROJ_PFAD%MessPunktMarker\Classifier\cascade.xml
::cascade_Mercedes_Logo__Stern__V07.xml
